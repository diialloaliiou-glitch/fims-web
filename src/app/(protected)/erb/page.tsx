...
function Colonne({
  ...
  return (
    <div>
      <p className="mb-3 font-semibold text-slate-100">{titre}</p>
      ...
      >
        ...
        <button
          type="submit"
          disabled={saving}
          className="rounded-md bg-emerald-500 px-4 py-1.5 text-sm font-medium text-slate-950 hover:bg-emerald-400 disabled:opacity-60"
        >
          {saving ? "..." : "+ Ajouter"}
        </button>
      </form>
