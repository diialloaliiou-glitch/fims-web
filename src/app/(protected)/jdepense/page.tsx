  ...
  return (
    <div>
      ...
      <div className="max-h-[65vh] overflow-auto rounded-xl border border-border-subtle print:max-h-none print:overflow-visible">
        <table className="min-w-full table-auto text-sm [&_td]:whitespace-nowrap [&_td]:px-4 [&_td]:py-2.5 [&_td]:border-r [&_td]:border-border-subtle [&_th]:border-r [&_th]:border-border-subtle [&_tr>*:last-child]:border-r-0">
          <MiniTableHeader
            columns={[
              t.jdepense.colIndex,
              t.jdepense.colDate,
            ...
            minWidths={[
              ...
              undefined, undefined, 420, undefined, undefined, undefined, undefined,
            ]}
            noWrap
          />
